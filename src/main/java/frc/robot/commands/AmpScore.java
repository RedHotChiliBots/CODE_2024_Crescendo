...
public class AmpScore extends SequentialCommandGroup {
  ...
  public AmpScore(Trapper trapper, Intake intake, Feeder feeder, Shooter shooter) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
        // new ShootPosNote(trapper, intake, feeder, shooter),
        // new WaitCommand(1.0),
        // new InstantCommand(() -> trapper.holdTilt(TrapperConstants.kScoreTiltDeg),
        // trapper),
        // new InstantCommand(() -> trapper.holdLift(23.0), trapper),
        // new WaitCommand(2.5),,
...
//        new WaitCommand(1.0),
        ...
        // new WaitCommand(2.0),
        // new InstantCommand(() -> trapper.holdClaw(CLAW.CLOSE), trapper),
        new WaitCommand(0.2),
